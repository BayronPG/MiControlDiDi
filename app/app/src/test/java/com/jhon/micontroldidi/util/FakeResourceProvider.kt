...
class FakeResourceProvider : ResourceProvider {
    ...
    private val map = mapOf(
        ...
        com.jhon.micontroldidi.R.string.error_viaje_plataforma_obligatoria to "Indica la plataforma del viaje",
        com.jhon.micontroldidi.R.string.error_viaje_zona_obligatoria to "Indica la zona del viaje",
        com.jhon.micontroldidi.R.string.error_viaje_forma_pago_obligatoria to "Selecciona la forma de pago",
        com.jhon.micontroldidi.R.string.error_distancia_negativa to "La distancia no puede ser negativa",
        com.jhon.micontroldidi.R.string.error_peaje_negativo to "El peaje no puede ser negativo",
        com.jhon.micontroldidi.R.string.tanqueos_error to "Error al cargar los tanqueos",
        com.jhon.micontroldidi.R.string.tanqueo_no_encontrado to "Tanqueo no encontrado",
        com.jhon.micontroldidi.R.string.error_tanqueo_litros to "Los litros deben ser mayores que cero",
        com.jhon.micontroldidi.R.string.error_tanqueo_importe to "El importe debe ser mayor que cero",
        com.jhon.micontroldidi.R.string.error_tanqueo_odometro to "El odómetro no puede ser negativo",
        com.jhon.micontroldidi.R.string.error_tanqueo_tipo to "Indica el tipo de combustible",
        com.jhon.micontroldidi.R.string.error_guardar_tanqueo to "No se pudo guardar el tanqueo. Inténtalo de nuevo.",
        com.jhon.micontroldidi.R.string.error_eliminar_tanqueo to "No se pudo eliminar el tanqueo. Inténtalo de nuevo.",
        com.jhon.micontroldidi.R.string.gasto_de_tanqueo to "Gasto de tanqueo",
        com.jhon.micontroldidi.R.string.gasto_vinculado_no_editable to "Este gasto viene de un tanqueo: se edita en Tanqueos",
        com.jhon.micontroldidi.R.string.error_jornada_hora_fin to "La hora de fin no puede ser anterior al inicio",
        com.jhon.micontroldidi.R.string.error_jornada_odometro_final to "El odómetro final no puede ser menor que el inicial",
        com.jhon.micontroldidi.R.string.error_jornada_ya_cerrada to "Esta jornada ya está cerrada",
        com.jhon.micontroldidi.R.string.error_cerrar_jornada to "No se pudo cerrar la jornada. Inténtalo de nuevo.",
